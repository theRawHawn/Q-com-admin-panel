...
class AdminStore {
  ...
  constructor() {
    this.pricingConfig = {
      ...
      defaultSellerCommissionPercent: 15.0,
      riderBasePay: 40,
      riderPerKmPay: 12,
      surgeActive: false,
      surgeMultiplier: 1.0,
  ...
  private seedInitialData() {
    ...
    this.products = [
        ...
        sellers: [
          {
            ...
            cityId: 'bengaluru',
            cityName: 'Bengaluru',
            areaName: 'Koramangala 4th Block, Bengaluru',
            isStoreOnline: true,
            stockCount: 142,
            price: 580,
            mrp: 750,
            minStockAlert: 20,
            lastRestockedAt: 'Today, 09:30 AM',
            sellerContact: '+91 98450 12345',
          },
          {
            sellerId: 'sel-02',
            sellerName: 'Bengaluru Pipe & Plumbing Depot',
            cityId: 'bengaluru',
            cityName: 'Bengaluru',
            areaName: 'HSR Layout Sector 2, Bengaluru',
            isStoreOnline: true,
            stockCount: 65,
            price: 585,
            mrp: 750,
            minStockAlert: 15,
            lastRestockedAt: 'Yesterday, 04:15 PM',
            sellerContact: '+91 98450 23456',
          },
          {
            sellerId: 'sel-mum-02',
            sellerName: 'BKC Electrical Supplies & Industrial Cables',
            cityId: 'mumbai',
            cityName: 'Mumbai',
            areaName: 'BKC Bandra East, Mumbai',
            isStoreOnline: true,
            stockCount: 88,
            price: 580,
            mrp: 750,
            minStockAlert: 20,
            lastRestockedAt: 'Today, 08:45 AM',
            sellerContact: '+91 98210 99881',
          },
          {
            sellerId: 'sel-del-02',
            sellerName: 'Okhla Switchgear & Industrial Automation',
            cityId: 'delhi',
            cityName: 'Delhi NCR',
            areaName: 'Okhla Industrial Area Phase III, Delhi',
            isStoreOnline: true,
            stockCount: 110,
            price: 575,
            mrp: 750,
            minStockAlert: 25,
            lastRestockedAt: 'Today, 11:20 AM',
            sellerContact: '+91 98100 77123',
          },
          {
            sellerId: 'sel-hyd-01',
            ...
            cityId: 'hyderabad',
            cityName: 'Hyderabad',
            areaName: 'Madhapur / Hitec City, Hyderabad',
            isStoreOnline: true,
            stockCount: 44,
            price: 590,
            mrp: 750,
            minStockAlert: 15,
            lastRestockedAt: '2 days ago',
            sellerContact: '+91 98490 55678',
          },
          {
            sellerId: 'sel-chn-01',
            ...
            cityId: 'chennai',
            cityName: 'Chennai',
            areaName: 'Guindy Industrial Estate, Chennai',
            isStoreOnline: false,
            stockCount: 30,
            price: 580,
            mrp: 750,
            minStockAlert: 10,
            lastRestockedAt: '3 days ago',
            sellerContact: '+91 98400 88231',
          },
        ],
      },
      {
        ...
        sellers: [
          {
            ...
            mrp: 3100,
            minStockAlert: 15,
            lastRestockedAt: 'Today, 10:00 AM',
            sellerContact: '+91 98450 12345',
          },
          {
            sellerId: 'sel-mum-02',
            ...
            mrp: 3100,
            minStockAlert: 15,
            lastRestockedAt: 'Yesterday, 06:30 PM',
            sellerContact: '+91 98210 99881',
          },
          {
            sellerId: 'sel-del-02',
            ...
            mrp: 3100,
            minStockAlert: 12,
            lastRestockedAt: 'Today, 07:15 AM',
            sellerContact: '+91 98100 77123',
          },
          {
            sellerId: 'sel-chn-01',
          ...
          },
          {
            ...
            cityId: 'hyderabad',
            cityName: 'Hyderabad',
            areaName: 'Madhapur, Hyderabad',
            isStoreOnline: true,
            stockCount: 18,
            price: 2450,
            mrp: 3100,
            minStockAlert: 8,
            lastRestockedAt: '4 days ago',
            sellerContact: '+91 98490 55678',
          },
        ],
      },
        ...
        sellers: [
          {
            ...
            cityId: 'mumbai',
            cityName: 'Mumbai',
            areaName: 'Andheri East MIDC, Mumbai',
            isStoreOnline: true,
            stockCount: 84,
            price: 1850,
            mrp: 2300,
            minStockAlert: 25,
            lastRestockedAt: 'Today, 08:30 AM',
            sellerContact: '+91 98200 45678',
          },
          {
            sellerId: 'sel-del-01',
            ...
            cityId: 'delhi',
            cityName: 'Delhi NCR',
            areaName: 'Cyber City Phase 2, Gurugram',
            isStoreOnline: true,
            stockCount: 62,
            price: 1850,
            mrp: 2300,
            minStockAlert: 20,
            lastRestockedAt: 'Today, 10:15 AM',
            sellerContact: '+91 98110 33445',
          },
          {
            sellerId: 'sel-chn-01',
            sellerName: 'Guindy Industrial Fasteners & Bearings',
        ...
        sellers: [
          {
            ...
            cityId: 'delhi',
            cityName: 'Delhi NCR',
            areaName: 'Cyber City, Gurugram',
            isStoreOnline: true,
            stockCount: 28,
            price: 3499,
            mrp: 4500,
            minStockAlert: 8,
            lastRestockedAt: 'Today, 09:10 AM',
            sellerContact: '+91 98110 33445',
          },
          {
            sellerId: 'sel-mum-01',
            ...
            mrp: 4500,
            minStockAlert: 6,
            lastRestockedAt: 'Yesterday, 03:00 PM',
            sellerContact: '+91 98200 45678',
          },
          {
            sellerId: 'sel-01',
        ...
        sellers: [
          {
            ...
            mrp: 460,
            minStockAlert: 25,
            lastRestockedAt: 'Today, 08:00 AM',
            sellerContact: '+91 98450 23456',
          },
          {
            sellerId: 'sel-hyd-01',
        ...
        sellers: [
          {
            ...
            mrp: 550,
            minStockAlert: 30,
            lastRestockedAt: 'Today, 09:45 AM',
            sellerContact: '+91 98400 88231',
          },
          {
            sellerId: 'sel-mum-01',
          ...
          },
          {
            ...
            mrp: 550,
            minStockAlert: 15,
            lastRestockedAt: 'Yesterday, 04:30 PM',
            sellerContact: '+91 98110 33445',
          },
          {
            sellerId: 'sel-01',
      ...
      },
      {
        id: 'prod-07',
        sku: 'SKU-ELE-8537',
        name: 'Havells Crabtree Athena 6A 1-Way Modular Switch (White)',
        category: 'Electrical & Switchgear',
        ...
        sellers: [
          {
            ...
            mrp: 120,
            minStockAlert: 40,
            lastRestockedAt: 'Today, 11:00 AM',
            sellerContact: '+91 98450 12345',
          },
          {
            sellerId: 'sel-mum-02',
            ...
            mrp: 120,
            minStockAlert: 35,
            lastRestockedAt: 'Today, 08:15 AM',
            sellerContact: '+91 98210 99881',
          },
          {
            sellerId: 'sel-del-02',
            ...
            cityId: 'delhi',
            cityName: 'Delhi NCR',
            areaName: 'Okhla Phase III, Delhi',
            isStoreOnline: true,
            stockCount: 210,
            price: 84,
            mrp: 120,
      ...
      },
      {
        id: 'prod-08',
        sku: 'SKU-SAF-6506',
        name: 'Karam PN-56 Full Body Work Safety Harness & Lanyard',
        category: 'Safety & Industrial PPE',
        ...
        sellers: [
          {
            ...
            mrp: 2100,
            minStockAlert: 10,
            lastRestockedAt: 'Today, 10:30 AM',
            sellerContact: '+91 98200 45678',
          },
          {
            sellerId: 'sel-del-01',
      ...
      },
      {
        id: 'prod-09',
        sku: 'SKU-PLM-3917',
        name: 'Supreme Aqua Gold 1-inch CPVC Pipe (3 Meter Length)',
        category: 'Plumbing & Drainage',
      ...
      },
      {
        id: 'prod-10',
        sku: 'SKU-CHM-3214',
        name: 'Fosroc Renderoc Plug Instant Leak Sealing Mortar (5kg)',
        category: 'Construction Chemicals',
        subcategory: 'Waterproofing & Grouts',
        brand: 'Fosroc',
        price: 740,
        mrp: 950,
        unit: 'Bucket',
        ...
        sellers: [
          {
            ...
            mrp: 950,
            minStockAlert: 8,
            lastRestockedAt: 'Today, 09:00 AM',
            sellerContact: '+91 98450 23456',
          },
          {
            sellerId: 'sel-del-01',
